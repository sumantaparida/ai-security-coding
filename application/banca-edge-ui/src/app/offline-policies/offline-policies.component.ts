...
@Component({
  selector: 'app-offline-policies',
  templateUrl: './offline-policies.component.html',
  styleUrls: ['./offline-policies.component.css'],
  animations: [
...
export class OfflinePoliciesComponent implements OnInit {
  customerId: number;
  columnsToDisplay = [
    ' ',
    'Insurer Name',
  ...
  constructor(
    ...
    private offlinePoliciesService: OfflinePoliciesService,
  ...
  getPolicyApplicationDetails() {
    this.offlinePoliciesService.getPolicyApplicationForUser().subscribe(
      (policyDetails) => {
        // this.isLoading = false;
        this.loaderService.showSpinner(false);
