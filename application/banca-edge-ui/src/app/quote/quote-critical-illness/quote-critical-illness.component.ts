...
@Component({
  selector: 'app-quote-critical-illness',
  templateUrl: './quote-critical-illness.component.html',
  styleUrls: ['./quote-critical-illness.component.css'],
})
export class QuoteCriticalIllnessComponent implements OnInit, OnDestroy {
