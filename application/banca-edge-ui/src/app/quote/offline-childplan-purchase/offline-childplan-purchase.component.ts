...
@Component({
  selector: 'app-offline-childplan-purchase',
  templateUrl: './offline-childplan-purchase.component.html',
  styleUrls: ['./offline-childplan-purchase.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class OfflineChildplanPurchaseComponent implements OnInit {
