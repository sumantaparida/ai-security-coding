...
import {
  ...
  PolicyQuoteList,
} from '../display-result-annuity/display-result-annuity.component';

@Component({
  selector: 'app-more-detail-annuity',
  templateUrl: './more-detail-annuity.component.html',
  styleUrls: ['./more-detail-annuity.component.css'],
})
export class MoreDetailAnnuityComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<MoreDetailAnnuityComponent>,
