...
@Component({
  selector: 'app-offline-protection-purchase',
  templateUrl: './offline-protection-purchase.component.html',
  styleUrls: ['./offline-protection-purchase.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class OfflineProtectionPurchaseComponent implements OnInit {
