...
@Component({
  selector: 'app-quote-unit-linked',
  templateUrl: './quote-unit-linked.component.html',
  styleUrls: ['./quote-unit-linked.component.css'],
})
export class QuoteUnitLinkedComponent implements OnInit, OnDestroy {
