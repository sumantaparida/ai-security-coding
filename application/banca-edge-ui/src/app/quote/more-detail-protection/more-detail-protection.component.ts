...
import {
  ...
  PolicyQuoteList,
} from '../display-result-protection-quote/display-result-protection-quote.component';

@Component({
  selector: 'app-more-detail-protection',
  templateUrl: './more-detail-protection.component.html',
  styleUrls: ['./more-detail-protection.component.css'],
})
export class MoreDetailProtectionComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<MoreDetailProtectionComponent>,
