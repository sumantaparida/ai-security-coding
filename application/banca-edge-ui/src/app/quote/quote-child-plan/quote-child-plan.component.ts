...
@Component({
  selector: 'app-quote-child-plan',
  templateUrl: './quote-child-plan.component.html',
  styleUrls: ['./quote-child-plan.component.css'],
})
export class QuoteChildPlanComponent implements OnInit, OnDestroy {
