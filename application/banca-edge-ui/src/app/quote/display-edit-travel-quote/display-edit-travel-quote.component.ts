import { Component, Input, OnChanges, OnInit, Output, ElementRef, EventEmitter, ViewChild } from '@angular/core';
import { FormControl, FormGroup } from '@angular/forms';
import { MatDialog } from '@angular/material/dialog';
import { Router } from '@angular/router';

@Component({
  selector: 'app-display-edit-travel-quote',
  templateUrl: './display-edit-travel-quote.component.html',
  styleUrls: ['./display-edit-travel-quote.component.css']
})
export class DisplayEditTravelQuoteComponent implements OnInit, OnChanges {
  ...
  generateFinalQuoteData() {
    ...
    if (this.membersArr !== undefined) {
      ...
      this.productType = this.finalQuote?.quoteInput?.productType;
      this.travelStartDate = this.finalQuote?.quoteInput?.travelStartDate;
      this.travelEndDate = this.finalQuote?.quoteInput?.travelEndDate;
      this.incomeOrSa = this.finalQuote?.quoteInput?.sa;
  ...
  routeToQuestion() {
    this.router.navigateByUrl('/quote/travel-details/' + this.quoteId);
  }
