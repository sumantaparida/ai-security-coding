...
@Component({
  selector: 'app-display-edit-ci',
  templateUrl: './display-edit-ci.component.html',
  styleUrls: ['./display-edit-ci.component.css'],
})
export class DisplayEditCiComponent implements OnInit, OnChanges {
  ...
  routeToQuestion() {
    this.router.navigate(['/quote/critical-ill', this.quoteId]);
  }
}
