...
@Component({
  selector: 'app-display-result-unit-linked',
  templateUrl: './display-result-unit-linked.component.html',
  styleUrls: ['./display-result-unit-linked.component.css'],
})
export class DisplayResultUnitLinkedComponent implements OnInit, OnChanges {
