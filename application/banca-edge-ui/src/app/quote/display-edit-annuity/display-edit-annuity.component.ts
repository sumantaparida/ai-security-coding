...
@Component({
  selector: 'app-display-edit-annuity',
  templateUrl: './display-edit-annuity.component.html',
  styleUrls: ['./display-edit-annuity.component.css'],
})
export class DisplayEditAnnuityComponent implements OnInit, OnChanges {
  pptOptions = {
    floor: 5,
    ceil: 50,
  };
  ...
  backrouteToQuestion() {
    ...
    this.router.navigate(['/quote/annuity', this.quoteId]);
