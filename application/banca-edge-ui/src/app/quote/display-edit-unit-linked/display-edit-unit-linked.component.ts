...
@Component({
  selector: 'app-display-edit-unit-linked',
  templateUrl: './display-edit-unit-linked.component.html',
  styleUrls: ['./display-edit-unit-linked.component.css'],
})
export class DisplayEditUnitLinkedComponent implements OnInit, OnChanges {
  pptOptions = {
    floor: 5,
    ceil: 50,
  };
  ...
  backrouteToQuestion() {
    ...
    this.router.navigate(['/quote/unit-link', this.quoteId]);
